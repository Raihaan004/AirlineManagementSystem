...
public class Cancel extends JFrame implements ActionListener{
    JTextField tfpnr;
    JLabel tfname, cancellationo, lblfcode, lbldateoftravel;
    ...
    public Cancel() {
        ...
        cancellationo = new JLabel(""+random.nextInt(1000000));
        cancellationo.setBounds(220,180,150,25);
        add(cancellationo);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == fetchButton) {
            ...
            String pnr = tfpnr.getText();
            String cancelno = cancellationo.getText();
